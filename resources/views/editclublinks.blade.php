...
<div class="tab-pane fade in active" id="social">
    <form class="form-horizontal" style="background:#fff;padding:35px" method="post" action="{{url('/edit-clublinks/'.$club_id)}}">
      {{csrf_field()}}
        ...
        <div class="form-group">
          <label class="control-label col-sm-4" for="txt">Facebook:</label>
              <div class="col-sm-6">
                ...
                <input type="text" class="form-control" id="txt" name="facebook" value="{{$links->Facebook}}">
              </div>
      </div>
        <div class="form-group">
            <label class="control-label col-sm-4" for="email">Google+:</label>
                <div class="col-sm-6">
                    <input type="email" class="form-control" id="email" name="google" value="{{$links->GooglePlus}}">
                </div>
      </div>
      <div class="form-group">
            <label class="control-label col-sm-4" for="txt">Twitter:</label>
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="txt" name="twitter" value="{{$links->Twitter}}">
                </div>
    </div>
     <div class="form-group">
        <label class="control-label col-sm-4" for="txt">Others:</label>
              <div class="col-sm-6">
                <input type="text" class="form-control" id="txt" name="others" value="{{$links->Others}}">
              </div>
    </div>
     
    <center>
       <a href="{{ url('edit-clubcontact/'.$club_id) }}" class="btn btn-primary">Back</a>
