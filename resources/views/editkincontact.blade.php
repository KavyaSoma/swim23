        ...
        {{csrf_field()}}
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="contactname" name="EmergencyContactName" value="{{$participant->EmergencyContactName}}" required>
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="contactnumber" name="EmergencyContactNumber" value="{{$participant->EmergencyContactNumber}}" required>
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="address" name="EmergencyContactAddress" value="{{$participant->EmergencyContactAddress}}" required>
                </div>
                </div>
                 ...
                 @endforeach
                  ...
                  <center>
                        <a href="{{url('editkin/'.$participant_id)}}" class="btn btn-primary">Back</a>
