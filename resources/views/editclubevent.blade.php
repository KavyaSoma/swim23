...
@if(session()->has('message.level'))
 ...
 <div class="container" id="main-code">
    ...
    @if(count($contacts)>0)
    <li><a class="btn btn-primary" href="{{url('edit-eventcontact/'.$event_id.'/'.$contacts[0]->ContactId)}}"> Edit Contact</a></li>
    @else
    <li><a class="btn btn-primary" href="{{url('contact--event/'.$event_id)}}"> Add Contact</a></li>
    @endif
  </ul>
