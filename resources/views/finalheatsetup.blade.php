            ...
            <div class="liner"></div>
              <li>
                <a href="{{url('heatsetup/'.$event_id)}}"  class="tab-one"title="Stage Summary">
                 ...
                 <li>
                   <a href="{{url('semiheatsetup/'.$event_id)}}" title="Manage Participants">
                      <span class="round-tabs">
                 ...
                 <li class="active">
                  ...
                  <div class="tab-content tab_details">
                    ...
                    <div class="tab-pane fade in active" id="stagesummary">
                      ...
                      <form class="form-horizontal" style="background:#fff;" method="post" action="{{url('finalheatsetup/'.$event_id.'/'.$subevent_id)}}">
                        {{csrf_field()}}
...
console.log('{{ url('oldfinalheat/'.$event_id.'/'.$subevent_id) }}');
$.ajax({
    url: '{{ url('oldfinalheat/'.$event_id.'/'.$subevent_id)  }}',
