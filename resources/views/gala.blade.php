...
@if(session()->has('message.level'))
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      <div class="container"><!--id="main-code"-->
        <form class="form-horizontal kin_infor" method="post" action="{{url('/addevent')}}" enctype="multiplart/form-data">
          {{csrf_field()}}
...
<div class="well" style="background:#fff;margin-top:43px;">
          ...
          <div class="form-group" id="field1">
            <label class="control-label col-xs-4 col-sm-4" for="txt">GalaName/EventName:</label>
