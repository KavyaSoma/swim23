  ...
  <div class="col-xs-12 col-sm-12 col-md-offset-2 col-md-6 col-lg-offset-2 col-lg-6 register_form">
                    <form method="post" action="{{ url('updatepassword') }}">
                     ...
                     <div class="form-group">
                      <input type="text" class="form-control"  placeholder="Your Mail" name="email" id="textbox" required>
                        <input type="hidden" name="name" value="{{ $name }}">
                    <input type="hidden" name="image" value="{{ $image }}">
                       </div>
                    <div class="form-group">
                    <button type="submit" name="submit" class="btn btn-primary butn col-xs-8 col-sm-11">Login</button><br><br>
                  </div>
