...
<div class="tab-content tab_details">
    ...
    <div class="form-group"  id="field1">
      ...
      <label class="radio-inline containerh">Male<input type="radio" name="gender" value="Male" @if($event->Gender=="Male") checked @endif required><span class="checkmark" required></span></label>
      <label class="radio-inline containerh">Female<input type="radio" name="gender" value="Female" @if($event->Gender=="Female") checked @endif required><span class="checkmark" required></span></label>
      <label class="radio-inline containerh">Both<input type="radio" name="gender" value="Both" @if($event->Gender=="Both") checked @endif required><span class="checkmark" required></span></label>
    ...
    <div class="form-group">
                          <label class="control-label col-xs-5 col-sm-offset-2 col-sm-2" for="txt">Disabled Only?:</label>
                              <div class="col-xs-7 col-sm-4">
                <input type="radio" name="disabled" value="yes" id="yes" @if($event->AbleBodied == "yes") checked @endif/>
                <input type="radio" name="disabled" value="no" id="no" @if($event->AbleBodied == "no") checked @endif />
                <div class="switch radio-inline">
                  <label for="yes"  @if($event->AbleBodied == "yes") checked @endif>Yes</label>
                  <label for="no" @if($event->AbleBodied == "no") checked @endif >No</label>
                  <span></span>
                </div>
    ...
    <div class="form-group"  id="field1">
      <label class="control-label col-xs-4 col-sm-4" for="txt">SubEvent Name:</label>
      <div class="col-xs-7 col-sm-6">
        <input type="text" class="form-control" id="sub-event" name="subevent_names" value="{{old('subevent_name')}}" pattern="([A-zÀ-ž\s]){3,25}" required>
        <span class="error" style="color: red;display: none;">SubEvent Name should contain 5-25 characters</span>
      </div>
    </div>
  <div class="form-group mob-none">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-7 col-sm-6">
        <textarea type="text" class="form-control" id="txt" name="descriptions" required>{{old('description')}}</textarea>
      </div>
    </div>
    <div class="form-group">
                          <label class="control-label col-xs-5 col-sm-offset-2 col-sm-2" for="txt">Disabled Only?:</label>
   ...
   <!-- when privacy is set as personal participants block should be displayed-->
    ...
    <h5 style="color:#46A6EA;text-align: center;width: 57%;"><b>Participants</b></h5>
                  ...
                  <center>
                        ...
                        <form method="get" action="{{url('editpage/event/venue/'.$event_id)}}">
