...
<center>
  ...
  <h3 style="color:  #46A6EA;" id="image_font"><b>Welcome to SwimmIQ</b></h3><br>
      <div class="col-xs-12">
        @if(count($users)>0)
      <h4 id="image_text">{{$guest_name}} Has Created an event on behalf of you.</h4></div>
      <h4 style="color: #FF9900">Please,<a href="{{ url('login') }}" style="color: #46A6EA;"><b>Click Here</b></a><span style="color: black"> to Login to Swimmiq and access Event ({{$event_name}}). </span></h4>
      @else
      <h4 style="color: #FF9900">It seems like you have not joined SwimmIQ. Please<a href="{{ $activation_url }}" style="color: #46A6EA;"><b>Click Here</b></a><span style="color: black"> to join SwimmIQ and access Event ({{$event_name}}). </span></h4>
      @endif
</div>
</div>
<!-- footer starts here -->
