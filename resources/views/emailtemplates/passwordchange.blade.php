...
<center>
  ...
  <div class="col-xs-12"><br><br>
      <h4 id="image_text"> Your Swimmiq Account Password has been changed</h4>
      <h4>Password changed sucessfully,You're getting this email to make sure it was you</h4>
      <h4>If it is not you,Please change your password by clicking on forget password in Swimmiq</h4></div>
      <h4 style="color: #FF9900"><a href="{{ $activation_url }}" style="color: #46A6EA;"><b>Click Here</b></a><span style="color: black"> to reset your account password</span></h4>
</div>
</div>
<!-- footer starts here -->
