...
<center>
  ...
  <h3 style="color:  #46A6EA;" id="image_font"><b>{{$venue_name}} for {{$event_name}} Rejected</b></h3><br>
      <div class="col-xs-12">
      <h4 id="image_text">Venue {{$venue_name}} for your Event {{$event_name}} has been Rejected.</h4></div>
      <h4 style="color: #FF9900">Venue <span style="color: green"> {{$venue_name}} </span>is already assigned to another Event.</h4>
</div>
</div>
<!-- footer starts here -->
