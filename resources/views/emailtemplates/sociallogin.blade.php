...
<center>
  ...
  <img src="{{ url('images/pool.jpg') }}" id="activation_img"/>
  <h3 style="color:  #46A6EA;" id="image_font"><b>Welcome to SwimmIQ</b></h3><br>
      <div class="col-xs-12">
      <h4 id="image_text">Thank You for Logging into SwimmIQ</h4></div>
      <h4 style="color: #FF9900"><a href="{{ url('/login') }}" style="color: #46A6EA;"><b>Click Here</b></a><span style="color: black"> to login to your account using this email and Temporary password [Welcome123]</span></h4>
</div>
</div>
<!-- footer starts here -->
