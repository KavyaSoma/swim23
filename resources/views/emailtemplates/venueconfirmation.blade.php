...
<center>
  ...
  <h3 style="color:  #46A6EA;" id="image_font"><b>{{$venue_name}} Confirmation</b></h3><br>
      <div class="col-xs-12">
      <h4 id="image_text">Venue Confirmed for your Event({{$event_name}})</h4></div>
      <h4 style="color: #FF9900">Venue <span style="color: green">({{$venue_name}})</span>is confirmed for your Event ({{$event_name}}).</h4>
</div>
</div>
<!-- footer starts here -->
