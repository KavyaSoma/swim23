...
<center>
  ...
  <h3 style="color:  #46A6EA;" id="image_font"><b>Welcome to SwimmIQ</b></h3><br>
      <div class="col-xs-12">
      <h4 id="image_text">You got an invitation from Swimmiq</h4><br><b>UserName :{{$email}}</b></br>
      <br><b>Password : {{$password}}</b></br></div>
      <h4 style="color: #FF9900"><a href="{{ $activation_url }}" style="color: #46A6EA;"><b>Click Here</b></a><span style="color: black"> to login to your account</span></h4>
</div>
</div>
<!-- footer starts here -->
