...
<!-- instructor preview code starts here -->
   ...
   <div class="col-sm-8 col-xs-12"><h3>{{$instructor->FirstName}}</h3></div>
 ...
 @include('instructorsidebar')
   ...
   <p>Email : hareesh.edula1234@gmail.com</p>
    ...
    <!--<ul class="nav nav-tabs preview_tabs mob-none">
         <li><a href="{{url('instructor/'.$instructor->ShortName)}}"> Basic Details</a></li>
         <li class="active  myactivet"><a style="border-bottom:0px;color:#f60;" href="{{url('instructor/'.$instructor->ShortName.'/instructorevents')}}">  Events</a></li>
         ...
         <li><a href="{{url('instructor/'.$instructor->ShortName.'/instructorqualification')}}"> Qualification</a></li>
         <!--<li><a href="{{url('instructor/'.$instructor->ShortName.'/instructorcontact')}}"> <i class="fa fa-phone" aria-hidden="true" id="info_fa"></i> Contact</a></li>
            <li><a href="{{url('instructor/'.$instructor->ShortName.'/bookinstructor')}}"> <i class="fa fa-pencil-square-o" aria-hidden="true" id="info_fa"></i> Book Instructor</a></li>
    </ul>
    <ul class="nav nav-tabs preview_tabs desk-none mob-block tab-none">
         ...
         <li class="active"><a href="{{url('instructor/'.$instructor->ShortName.'/instructorevents')}}"> <i class="fa fa-calendar" aria-hidden="true" id="info_fa"></i></a></li>
         ...
         <li><a href="{{url('instructor/'.$instructor->ShortName.'/instructorqualification')}}"> <i class="fa fa-graduation-cap" aria-hidden="true" id="info_fa"> </i></a></li>
         <!--<li><a href="{{url('instructor/'.$instructor->ShortName.'/instructorcontact')}}"> <i class="fa fa-phone" aria-hidden="true" id="info_fa"></i> </a></li>
            <li><a href="{{url('instructor/'.$instructor->ShortName.'/bookinstructor')}}"> <i class="fa fa-pencil-square-o" aria-hidden="true" id="info_fa"></i> </a></li>
   </ul>-->
   @endforeach
