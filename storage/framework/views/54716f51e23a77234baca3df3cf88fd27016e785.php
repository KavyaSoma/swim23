...
<div class="tab-content tab_details">
  <div class="tab-pane fade in active" id="basicdetails">
    <form class="form-horizontal" style="background:#fff;padding:35px" method="post" action="<?php echo e(url('/addclub')); ?>"  enctype="multipart/form-data">
    ...
    <div class="form-group">
              <label class="control-label col-sm-4" for="txt">Short Name:</label>
                  <div class="col-sm-6">
                      <input type="text" class="form-control" id="shortname" onblur="clubshortname('<?php echo e(url('checkshortname/club')); ?>')" name="short_name" value="" required>
                      <div id="message"></div>
                   </div>
            </div>      
    <!-- address -->      
