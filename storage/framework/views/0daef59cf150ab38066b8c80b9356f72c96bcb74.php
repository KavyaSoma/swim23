  ...
  <div class="container" style="margin-top:20px;background-color:#fff;padding:10px">
    ...
    <ul class="nav nav-tabs preview_tabs mob-none">
       <li><a href="<?php echo e(url('instructor/'.$instructor->ShortName)); ?>"> <i class="fa fa-info" aria-hidden="true" id="info_fa"></i> Basic Details</a></li>
         ...
         <li  class="active"><a href="<?php echo e(url('instructor/'.$instructor->ShortName.'/instructorqualification')); ?>"> <i class="fa fa-globe" aria-hidden="true" id="info_fa"></i> Qualification</a></li>
    ...
    <ul class="nav nav-tabs preview_tabs desk-none mob-block tab-none">
       <li><a href="<?php echo e(url('instructor/'.$instructor->ShortName)); ?>"> <i class="fa fa-info" aria-hidden="true" id="info_fa"></i></a></li>
         ...
         <li  class="active"><a href="<?php echo e(url('instructor/'.$instructor->ShortName.'/instructorqualification')); ?>"> <i class="fa fa-globe" aria-hidden="true" id="info_fa"></i></a></li>
...
<div id="instructorpreview-qualification" class="tab-pane fade in active">
   <form class="form-horizontal">
    <?php $__currentLoopData = $instructorqualification; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qualification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
     <div class="col xs-12 col-sm-12 col-md-12 col-lg-12">
  <div>
    <h4 class="field_names">Qualification</h4></div>
   <p><?php echo e($qualification->Qualification); ?></p><hr>
   <div>
   <h4 class="field_names">Specialization</h4></div>
   <p><?php echo e($qualification->Specialization); ?></p><hr>
   <div>
   <h4 class="field_names">Description</h4></div>
   <p><?php echo e($qualification->Description); ?></p>
   </div>
   </form>
   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
 </div>
