 ...
 <!-- Modal content-->
     <div class="modal-content">
       ...
       <div class="modal-body" style="padding:20px">
        <span id='msg' style="color:red;text-decoration: bold;"></span>
         <form class="form-horizontal" method="post" action="<?php echo e(url('postnews')); ?>" id="addform" enctype="multipart/form-data">
          <?php echo e(csrf_field()); ?>
           ...
           <div class="form-group">
             ...
             <div class="col-sm-6">
               <input type="date" class="form-control" id="fd" name="publish_date" onblur="checkdates('fd','sd','msg','sub')"  required>
             </div>
           </div>
           <div class="form-group">
             <label class="control-label col-sm-4" for="txt" style="color:#333">Expire Date:</label>
             <div class="col-sm-6">
               <input type="date" class="form-control" id="sd" name="expire_date" onblur="checkdates('fd','sd','msg','sub')"  required>
             </div>
           </div>
           <div class="form-group">
      ...
      <select class="form-control" name="post_type" required>
        ...
        <option value="Advertisement">Advertisement</option>
         ...
         <center><button class="btn btn-primary" type="reset">Cancel</button>
            <button class="btn btn-primary" id="sub">Save & Continue</button></center>
            </form>
