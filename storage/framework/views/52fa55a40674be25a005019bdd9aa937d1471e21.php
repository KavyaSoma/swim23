                 ...
                 <li>
                  ...
                  <div class="tab-content tab_details">
                    ...
                    <div class="tab-pane fade in active" id="stagesummary">
                      ...
                      <form class="form-horizontal" style="background:#fff;" method="post" action="<?php echo e(url('semiheatsetup/'.$event_id)); ?>">
...
console.log('<?php echo e(url('oldsemifinal/'.$event_id)); ?>');
$.ajax({
    url: '<?php echo e(url('oldsemifinal/'.$event_id)); ?>',
