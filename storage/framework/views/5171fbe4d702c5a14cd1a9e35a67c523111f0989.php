  ...
  <li class="breadcrumb-item active">Heat setup & Result entry</li>
   ...
   <div class="row text-center"> 
    ...
    <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr><td><?php echo e($event->EventName); ?></td><td><a href="<?php echo e(url('managesubevents/'.$event->EventId)); ?>" style="color:#000;">setup heats?</a></td><td><a href="#" style="color:#000;">results entry?</a></td></tr>
