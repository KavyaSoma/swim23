...
<div class="container mycntn">
  ...
  <form class="form-horizontal" style="background:#fff;padding:35px" method="post" action="<?php echo e(url('/addvenue/'.$venue_id)); ?>" enctype="multipart/form-data">
...
<?php if(count($venue_image)>0): ?>
 <img alt="Profile image" class="img-rounded profile_image" id="venue-image" src="<?php echo e($venue_image[0]->ImagePath); ?>">
 <input type="hidden" name="image_check" value="<?php echo e($venue_image[0]->ImagePath); ?>">
 <?php else: ?>
 <img alt="Profile image" class="img-rounded profile_image" id="venue-image" src="<?php echo e(url('public/images/venue.jpeg')); ?>">
 <input type="hidden" name="image_check" value="<?php echo e(url('public/images/venue.jpg')); ?>">
 <?php endif; ?>
...
<div class="col-sm-8 col-xs-12">
                 ...
                 <div class="liner"></div>
                  <li class="active">
                  <a href="<?php echo e(url('addvenue')); ?>" data-toggle="tab" class="tab-one" title="Venue Summary">
                   ...
                   <div class="tab-pane fade in active" id="venuesummary">
                    ...
                    <?php $__currentLoopData = $venue_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           ...
                           <div class="row">
                             <div class="form-group">
                                   ...
                                   <div class="col-xs-8 col-sm-9">
                                    ...
                                    <input type="hidden" name="venueid" value="<?php echo e($venue_id); ?>">
                                     <input type="text" class="form-control" id="venue-name" name="venue_name" value="<?php echo e($venue->VenueName); ?>"  required>
                      ...
                      <div class="form-group">
                         ...
                         <div class="col-xs-8 col-sm-9">
                           <textarea class="form-control" id="txt" name="description" required> <?php echo e($venue->Description); ?></textarea>
                         </div>
                       </div>
                       <div class="form-group">
                           <label class="control-label col-xs-4 col-sm-2" for="txt">Short Name:</label>
                           <div class="col-xs-8 col-sm-9">
                             <input type="text" class="form-control" id="venue-short-name" name="short_name" onblur="venueshortname('<?php echo e(url('checkshortname/venue')); ?>')" value="<?php echo e($venue->ShortName); ?>" required>
                             <div id="message"></div>
                           </div>
                         </div>
             <div class="form-group">
              <label class="control-label col-xs-4 col-sm-2">Address:</label>
                <div class="col-xs-8  col-sm-9 ">
                    <input type="text" class="form-control myful" name="address" value="<?php echo e($venue->AddressLine1); ?>" required>
                </div>
              ...
              <label class="control-label col-xs-4 col-sm-2" >Postcode:</label>
                <div class="col-xs-8  col-sm-9 ">
                    <input type="int" class="form-control myful" id="postcode" name="postcode" onblur="checkaddress('<?php echo e(url('/checkpostcode')); ?>')" value="<?php echo e($venue->PostCode); ?>" required>
              ...
              <label class="control-label col-xs-4 col-sm-2" >City:</label>
                <div class="col-xs-8  col-sm-9 ">
                    <input type="text" class="form-control myful" name="city" id="city" value="<?php echo e($venue->City); ?>" required>
              ...
              <label class="control-label col-xs-4 col-sm-2" >Country:</label>
                <div class="col-xs-8  col-sm-9 ">
                    <input type="text" class="form-control myful" name="country" id="country" value="<?php echo e($venue->Country); ?>" readonly>
     ...
     <div class="row">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                           <label class="control-label col-xs-4 col-sm-2" for="txt">Short Name:</label>
                           <div class="col-xs-8 col-sm-9">
                             <input type="text" class="form-control" id="venue-short-name" name="short_name" onblur="venueshortname('<?php echo e(url('checkshortname/venue')); ?>')" value="<?php echo e(old('short_name')); ?>" value="" required>
                             <div id="message"></div>
                           </div>
                         </div>
             <div class="form-group">
        ...
        <div class="form-group">
              <label class="control-label col-xs-4 col-sm-2" >Postcode:</label>
                <div class="col-xs-8  col-sm-9 ">
                    <input type="int" class="form-control myful" id="postcode" name="postcode" onblur="checkaddress('<?php echo e(url('/checkpostcode')); ?>')" value="" required>
...
<div class="col-sm-offset-5 col-xs-offset-4">
         ...
         <?php if(count($venue_details)>0): ?>
          <a href="<?php echo e(url('/venuepool/'.$venue_id)); ?>" class="btn btn-primary mybtn" >Next</a>
          <?php else: ?>
