            ...
            <div class="liner"></div>
              <li class="active">
                <a href=""  class="tab-one"title="Stage Summary">
                 ...
                 <li>
                   <?php if($stage_level >= 1): ?>    
                   <a href="<?php echo e(url('semiheatsetup/'.$event_id)); ?>" title="Setup Semifinals">
                      <span class="round-tabs">
                 ...
                 <li>
                   <?php if($stage_level >= 2): ?>  
                   <a href="<?php echo e(url('finalheatsetup/'.$event_id)); ?>" title="Setup Finals">
                      <span class="round-tabs">
                  ...
                  <div class="tab-content tab_details">
                    ...
                    <div class="tab-pane fade in active" id="stagesummary">
                      ...
                      <form class="form-horizontal" style="background:#fff;" method="post" action="<?php echo e(url('heatsetup/'.$event_id)); ?>">
...
<input type="text" class="form-control" name="id" value="<?php echo e($events[0]->EventId); ?>" required>
...
<div class="col-sm-6">
<input type="text" class="form-control"  name="max_participants" value="<?php echo e($events[0]->MaxParticipants); ?>" readonly required> 
</div>
</div>
<div class="form-group">
...
<?php endif; ?>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <input type="text" class="form-control" value="<?php echo e($events[0]->Relay); ?>" name="relay" required> 
        </div>
      </div>
      <div class="form-group">
...
console.log('<?php echo e(url('oldscheduleheat/'.$event_id)); ?>');
$.ajax({
    url: '<?php echo e(url('oldscheduleheat/'.$event_id)); ?>',
