            ...
            <div class="form-group">
              <label class="control-label col-xs-4 col-sm-4" for="imgUpload">Image:</label>
                <div class="col-xs-8 col-sm-4">
                    <input type="file" class="form-control fa fa-edit" id="imgUpload" name="imgUpload"  accept="image/*" required><span class="col-xs-8 btn btn-default mob-block desk-none tab-none" style="margin-top: 2%;"> <i class="fa fa-edit" style="color:#ff6600" title="Edit"> </i> Edit Image</span>
                </div>
