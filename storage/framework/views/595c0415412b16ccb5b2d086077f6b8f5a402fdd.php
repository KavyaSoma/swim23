        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 search">
                    <form id="search_form" action="<?php echo e(url('search/all')); ?>" method="get">
                    <div class="input-group">
                      ...
                      <select id="search_select" onchange="selectSearch()">
                        <option value="all" style="color:#000" <?php if(Request::has('search_term')&&$search_type=='all'): ?> selected <?php endif; ?>>All</option>
                        <option value="clubs" style="color:#000" <?php if(Request::has('search_term')&&$search_type=='clubs'): ?> selected <?php endif; ?>>Clubs</option>
                        <option value="events" style="color:#000" <?php if(Request::has('search_term')&&$search_type=='events'): ?> selected <?php endif; ?>>Events</option>
                        <option value="venues" style="color:#000" <?php if(Request::has('search_term')&&$search_type=='venues'): ?> selected <?php endif; ?>>Venues</option>
                        <option value="instructors" style="color:#000" <?php if(Request::has('search_term')&&$search_type=='instructors'): ?> selected <?php endif; ?>>Instructors</option>
                        <option value="users" style="color:#000" <?php if(Request::has('search_term')&&$search_type=='users'): ?> selected <?php endif; ?>>Users</option>
                      </select>
                     </div>
                       <div class="input-group-btn search-bar">
                          <?php if(Request::has('search_term')&&$search_term!=''): ?> 
                          <input type="text" placeholder="Search..." id="search-input" name="search_term" value="<?php echo e($search_term); ?>" class="form-control" required/>
                          <?php else: ?>
...
<ul class="list-inline" >
  ...
  <li><a href="<?php echo e(url('addclub')); ?>">Add Club</a></li>
  <li><a href="<?php echo e(url('clubinfo')); ?>">Manage clubs</a></li>
  <?php endif; ?>
  ...
  <li><a href="<?php echo e(url('manageheatsetup')); ?>">Heat Setup & Results Entry</a></li>
  <li><a href="<?php echo e(url('managevenues')); ?>">My Venues</a></li>
  <?php endif; ?>
  <li><a href="#"><hr></a></li>
  ...
  <li><a href="<?php echo e(url('/logout')); ?>">Logout</a></li>
            ...
            <div class="container">
                <nav class="navigation">
                    <ul class="list-inline pull-left">
                      ...
                      <li><a href="<?php echo e(url('/userdashboard')); ?>">Dashboard</a></li>
                      <?php endif; ?>
                      <?php if(Session::get('user_type') == "instructor"): ?>
                      <li><a href="<?php echo e(url('/instructordashboard')); ?>">Dashboard</a></li>
                      <?php endif; ?>
                      <?php if(Session::get('user_type') == "venue"): ?>
                      <li><a href="<?php echo e(url('/venuedashboard')); ?>">Dashboard</a></li>
                      <?php endif; ?>
                      <?php if(Session::get('user_type') == "club"): ?>
                      <li><a href="<?php echo e(url('/clubdashboard')); ?>">Dashboard</a></li>
                      <?php endif; ?>
                      <?php if(Session::get('user_type') == "admin"): ?>
                      <li><a href="<?php echo e(url('/admindashboard')); ?>">Dashboard</a></li>
                      <?php endif; ?>
                      <?php endif; ?>
                      <li><a href="<?php echo e(url('/poolfinder')); ?>">Poolfinder</a></li>
                      <li><a href="<?php echo e(url('/clubs')); ?>">Clubs</a></li>
                      <li><a href="<?php echo e(url('/eventsdashboard')); ?>">Events</a></li>
    ...
    <header class="animated  desk-none mob-block tab-block header-fixed">
			<div class="container">
				<div class="top-container clearfix">
					...
					<center><div class="logo">
						<a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('public/images/logo.png')); ?>" style="width: 69% !important;height: 50px;position: relative;top: 0px;left: 4px;"></a>
					</div>
		 ...
		 <nav class="drawermenu">
			...
			<ul class="list-inline">
			  <?php if(Session::has('user_id')): ?>
						  <li><a href="<?php echo e(url('/')); ?>"><b>Dashboard</b></a></li>
						  <li><a href="<?php echo e(url('/poolfinder')); ?>"><b>Poolfinder</b></a></li>
						  <li><a href="<?php echo e(url('/clubs')); ?>"><b>Clubs</b></a></li>
						  <li><a href="<?php echo e(url('/events')); ?>"><b>Events</b></a></li>
						  <li><a href="<?php echo e(url('/venues')); ?>"><b>Venues</b></a></li>
						  <li><a href="<?php echo e(url('/instructors')); ?>"><b>Instructors</b></a></li>
						  <li><a href="<?php echo e(url('/inbox')); ?>"><b>Messages</b></a></li>
						  <li><a href="<?php echo e(url('/socialnetwork')); ?>"><b>Social Network</b></a></li>
						  <?php else: ?>
						  <li></li>
					  <div class="container">
		...
		<a href="<?php echo e(url('/login')); ?>"><button type="submit" class="btn btn-primary">Submit</button></a>
	  </form>
	</div>
						  <?php endif; ?>
				 ...
				 <div class="col-md-2 col-xs-6 footer-links-head">
					<h3><b>HELP</b></h3>
						<ul>
							...
							<li><a href="<?php echo e(url('frequently-asked-questions')); ?>">FAQs</a></li>
...
<link rel="stylesheet" href="<?php echo e(asset('public/dist/ui/trumbowyg.min.css')); ?>" type="text/css" media="none" onload="if(media!='all')media='all'">
<link rel="stylesheet" href="<?php echo e(asset('public/dist/easycomplete/easy-autocomplete.min.css')); ?>" media="none" onload="if(media!='all')media='all'">
  <link rel="stylesheet" href="<?php echo e(asset('public/dist/easycomplete/easy-autocomplete.themes.min.css')); ?>" media="none" onload="if(media!='all')media='all'">
        ...
        <script src="<?php echo e(asset('public/dist/easycomplete/jquery.easy-autocomplete.min.js')); ?>"></script>
        <script src="<?php echo e(asset('public/dist/trumbowyg.min.js')); ?>"></script>
        <script src="<?php echo e(asset('public/dist/plugins/upload/trumbowyg.upload.min.js')); ?>"></script>
  <script>
...
$(document).ready(function() {
  ...
  $('#seditor').trumbowyg({
            svgPath: '<?php echo e(url("/public/dist/ui/icons.svg")); ?>',
            autogrow: false,
        ...
        ['horizontalRule'],
            ...
            upload: {
                ...
                fileFieldName: 'image',
                headers: {
                    'Authorization': 'Client-ID 70520c3dc40a6d7'
                },
