      ...
      <div class="board">
        <div class="board-inner">
          <center><ul class="nav nav-tabs nav_info" id="myTab">
              <div class="liner"></div>
                <li class="active">
                  <a href="<?php echo e(url('addkin')); ?>" class="tab-one" title="Kin Basic Details">
          ...
          <div class="tab-content tab_details">
              <div class="tab-pane fade in active" id="kin_basicdetails">
                    <form class="form-horizontal" method="post" action="<?php echo e(url('addkin')); ?>" style="background:#fff;padding:35px" enctype="multipart/form-data">
