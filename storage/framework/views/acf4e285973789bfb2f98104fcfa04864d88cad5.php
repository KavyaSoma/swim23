...
<div class="col-xs-12 col-sm-6">
                          ...
                          <div class="panel-body">
                            <div class="table table-responsive" id="user_scroll">
                              <?php if(count($subscribedevents)>0): ?>
    ...
    <?php $__currentLoopData = $subscribedevents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $events): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tbody>
      <tr>
        <td><?php echo e($events->EventName); ?></td>
        <td><?php echo e($events->StartDateTime); ?></td>
        <td><a href="<?php echo e(url('event/'.$events->ShortName)); ?>"><button class="btn btn-primary view_btn">View</button></a></td>
      </tr>
    </tbody>
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      ...
      <p><div class="table table-responsive" id="user_scroll">
        ...
        <tbody>
          <tr>
            <td><a href="<?php echo e(url('kininformation/'.$participant->ParticipantId)); ?>" style="color: black"><?php echo e($participant->ParticipantName); ?></a></td>
            <td><?php echo e($participant->Relationship); ?></td>
            <td><?php echo e($participant->HeatName); ?></td>
            <td><?php echo e($participant->Result); ?></td>
          </tr>
        </tbody>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </table>
