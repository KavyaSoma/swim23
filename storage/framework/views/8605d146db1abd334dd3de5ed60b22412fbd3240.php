...
<form class="form-horizontal" style="background:#fff;" method="post" action="<?php echo e(url('manageparticipants/'.$event_id.'/'.$subevent_id.'/'.$heat_id)); ?>">
...
<select class="form-control country" id="sel1"  name="heats_id" onchange="heats('<?php echo e(url('manageparticipants/'.$event_id.'/'.$subevent_id)); ?>')" required>
...
<form method="post" action="<?php echo e(url('manageparticipants/'.$event_id.'/'.$subevent_id.'/'.$heat_id)); ?>">
	<?php echo e(csrf_field()); ?>
