                            ...
                            <div class="media-left">
                             ...
                             <?php endif; ?>
                              ...
                              <div class="media-right">
                                  <a href="<?php echo e(url('/acceptclubrequest/'.$pending->ReferenceId.'/club')); ?>"><i class="fa fa-check-circle" aria-hidden="true" title="Accept" style="font-size:20px;color: #46A6EA;"></i></a>
                                  <a href="<?php echo e(url('/rejectclubrequest/'.$pending->ReferenceId.'/club')); ?>"><i class="fa fa-times-circle-o" aria-hidden="true" title="Reject" style="font-size:20px;color: #d9534f;" ></i></a>
                              </div>
                          </li>
